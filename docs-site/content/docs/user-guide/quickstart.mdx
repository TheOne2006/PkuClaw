...
- 阅读 [安装说明](/docs/user-guide/installation) 补齐工具依赖。
- 阅读 [配置说明](/docs/user-guide/configuration) 理解启动期配置和 runtime 配置的边界。
- 阅读 [Runtime 设计](/docs/developer-guide/runtime) 了解 realtime、loop、quick action 和 skill catalog。
